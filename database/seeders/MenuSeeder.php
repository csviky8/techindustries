    ...
    public function run(): void
    {
        $menus = [
            ...
            ['name' => 'Inventory Request', 'slug' => 'inventory-request',  'route' => null,                    'icon' => 'inventory',  'order' => 5, 'children' => [
                ['name' => 'Receive Inventory', 'slug' => 'inventory-request.requested',    'route' => '/inventory-request/requested',   'icon' => null, 'order' => 1],
                ['name' => 'Delivered Inventory', 'slug' => 'inventory-request.delivered',    'route' => '/inventory-request/delivered',   'icon' => null, 'order' => 2],
            ]],
