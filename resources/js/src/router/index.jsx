        ...
        children: [
            {
                ...
                children: [
                    ...
                    { path: '/authorization/approved-device', element: <FittedListPage title="Temporary Certificate" subtitle="All temporary certificate fitments" /> },
                    { path: '/mining-devices', element: <Placeholder title="Mining Devices" /> },
                    { path: '/inventory-request/requested', element: <Placeholder title="Receive Inventory" /> },
                    { path: '/inventory-request/delivered', element: <Placeholder title="Delivered Inventory" /> },
                    { path: '/reports', element: <Placeholder title="Reports" /> },
                    { path: '/add-on-plan/year', element: <Placeholder title="TOTAL Additional Recharge" /> },
                    { path: '/add-on-plan/balance-recharge', element: <Placeholder title="BALANCE Additional Recharge" /> },
